...
The vector math class handles calculations with vectors used throughout the project
(in force.cpp in particular). Specifically, a polar coordinate system based in the
Cartesian plane is utilized. */
