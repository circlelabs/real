...
*/
real::PlaneCoordinator::PlaneCoordinator()
{
...
*/
bool real::PlaneCoordinator::goToPoint(struct real::waypoint receivedPoint, bool isAvoidanceManeuver, bool isNewQueue)
{
	//clear the queues
	if(isNewQueue)
	{
		std::list<struct real::waypoint> emptyQueue;
...
*/
struct real::waypoint real::PlaneCoordinator::getWaypointOfQueue(bool isAvoidanceQueue, int position)
{
	//setup invalid return as default
	struct real::waypoint ret;
	ret.latitude = -1000;
	ret.longitude = -1000;
	ret.altitude = -1000;
	
	std::list<struct real::waypoint>::iterator ii;
	int count = 0;
...
*/
real::Command real::PlaneCoordinator::getPriorityCommand()
{
	//start with defaults
	real::Command ret;
	ret.planeID = -1;
...
*/
bool real::PlaneCoordinator::handleNewUpdate(real::TelemetryUpdate update, real::Command *newCommand)
{
