...
real::SimulatedPlane::SimulatedPlane()
{
	//make a bad ID
	this->planeID = -1;
}
...
*/
real::SimulatedPlane::SimulatedPlane(long long int planeID, real::CreateSimulatedPlane::Request &requestFromUser)
{
	//data from inputs
...
*/
bool real::SimulatedPlane::handleNewCommand(real::Command newCommand)
{
...
*/
bool real::SimulatedPlane::fillTelemetryUpdate(real::TelemetryUpdate *tUpdate)
{
